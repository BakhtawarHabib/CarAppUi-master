...
class VehicleInsurance extends StatefulWidget {
  const VehicleInsurance({Key? key}) : super(key: key);

  @override
  _VehicleInsuranceState createState() => _VehicleInsuranceState();
}
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Image.asset(
            "assets/images/vehiclehub/new/vehicleinsurance.png",
            width: 128.w,
            height: 123.h,
          ),
          SizedBox(
